...
percept_data = calc_circadian(percept_data,zone_index,2,2,1,1); % Full calculations including nonlinear AR
percept_data = calc_ROC(percept_data,zone_index,1); % Full ROC calculations including permutation testing
